                                                           ...
                                                           <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                              <div class="form-group">
                                                                ...
                                                                <input type="text" name="" id="precio_venta" class="form-control" disabled>
                                                              </div>
                                                            </div>
                                                           </div>
                           ...
                           <div class="card card-outline card-primary">
                               ...
                               <div class="card-body">
                                   ...
                                   <div class="row">
                                    ...
                                    <input type="text" name="" id="total_pagado" class="form-control">
                                    <script>
                                    ...
                                    <input type="text" name="" id="cambio" class="form-control" disabled>
                                   </div>
                                    </div>
                                   </div>
                                   <hr>
