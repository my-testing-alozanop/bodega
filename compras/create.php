                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <!-- <input type="date" name="fecha_ingreso" id="fecha_ingreso" class="form-control" disabled> -->
                                                             <input type="text" name="fecha_ingreso" id="fecha_ingreso" class="form-control" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                              ...
                              <div class="modal fade" id="modal-buscar_proveedor">
                                ...
                                foreach ($proveedores_datos as $proveedores_dato){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a href="https://wa.me/502<?php echo $proveedores_dato['celular'];?>" target="_blank" class="btn btn-success">
                ...
                <div class="row">
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <input type="hidden" value="<?php echo $contador_de_compras;?>" id="nro_compra">
                                            </div>
                                          </div>
                                          <div class="col-md-12">
                                            <div class="form-group">
